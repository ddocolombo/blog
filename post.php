    ...
    <div id="content">
        ...
        <article>
            ...
            <p>Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium, totam
                ...
                <ul>
                    <li class="creator"><a href="Cooley">Coooley</a></li>
                    <li>
                        <p>What's my Jewel worth in D2R? If you've ever wondered what the most valuable jwls in the game
                            are, we break all the abilities down here for Diablo 2 Resurrected jewelry (HLD and LLD, as
                            well).</p>
                    </li>
                    <li>
